...
public class DataBarang extends javax.swing.JFrame {
    ...
    public void cariData(){
        ...
        try {
            Connection c = koneksi.getKoneksiData();
            String sql = "Select * from barang where Kode_Barang like '%" + jTextField1.getText() + "%'" +
    ...
    private void initComponents() {
        ...
        cbUkuran.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "39", "40", "41", "42", "43" }));
